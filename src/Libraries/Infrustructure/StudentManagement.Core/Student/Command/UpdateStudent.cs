...
namespace StudentManagement.Core.Student.Command
{
    ...
    public class UpateStudentHandler : IRequestHandler<UpdateStudent, VmStudent>
    {
        private readonly IStudentRepository _studentRepository;
        private readonly IMapper _mapper;

        public UpateStudentHandler(IStudentRepository studentRepository, IMapper mapper)
        {

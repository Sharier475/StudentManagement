...
namespace StudentManagement.Infrustructure.Migrations
{
    ...
    [Migration("20230810095920_TeacherTable")]
            ...
            modelBuilder.Entity("StudentManagement.Model.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2023, 8, 10, 15, 59, 20, 357, DateTimeKind.Unspecified).AddTicks(9), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Status = 1,
                            StudentName = "Sharier"
                        });
            ...
            modelBuilder.Entity("StudentManagement.Model.Teacher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 8, 10, 15, 59, 20, 358, DateTimeKind.Unspecified).AddTicks(556), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Department = "IT",
                            Salary = 15000.0,
                            Status = 1,
